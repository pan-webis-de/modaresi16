#!/usr/bin/env python
# -*- coding: utf-8 -*-
import pan16_author_profiling


def load(label=None, language=None, types=None):
    """Returns the PAN 2016 dataset X, Y. Here X is the list of texts and Y the list of labels.
    ...
    """
    docs = pan16_author_profiling.load(language)
